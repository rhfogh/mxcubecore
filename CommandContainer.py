...
class CommandContainer:
    ...
    def setValue(self, channelName, value):
        warn("setValue is deprecated. Use set_channel_value instead", DeprecationWarning)
        self.set_channel_value(channelName, value)

    def getValue(self, channelName):
        warn("getValue is deprecated. Use get_channel_value instead", DeprecationWarning)

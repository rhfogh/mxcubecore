...
SPACEGROUP_DATA = [
    ...
    SpaceGroupInfo(146, "H3", "3", "-3"),
    SpaceGroupInfo(147, "P-3", "-3", "-3"),
    SpaceGroupInfo(148, "H-3", "-3", "-3"),
    ...
    SpaceGroupInfo(166, "H-3m", "-3m", "-3m"),
    SpaceGroupInfo(167, "H-3c", "-3m", "-3m"),

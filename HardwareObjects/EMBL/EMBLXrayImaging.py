...
class EMBLXrayImaging(QtGraphicsManager, AbstractCollect):
    ...
    def mouse_clicked(self, pos_x, pos_y, left_click):
        ...
        if self.centering_started:
            ...
            self.diffractometer_hwobj.set_static_positions(self.motor_positions)
    ...
    def stop_move_beam_mark(self):
        ...
        self.diffractometer_hwobj.set_imaging_beam_position(pos_x, pos_y)
    ...
    def pre_execute(self, data_model):
        ...
        if im_params.detector_distance is not None:
            ...
            #GB blocking for focused beam or multilayer tests
        ...
        self.motor_positions = self.diffractometer_hwobj.get_positions()

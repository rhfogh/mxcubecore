...
class ExporterMotor(AbstractMotor):
    ...
    def init(self):
        ...
        # GB: Sun Apr 28 12:15:41 CEST 2019
        # These untested camel-snake edits just drive crazy!
        # Were we running with broken kappa initialization since month because of that?
        # How many robot crashes, broken kappas and losts samples did that cost?
        #
